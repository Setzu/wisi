...
class SystemModel extends ConnectionModel
{
    ...
    public function selectASPUtilisation()
    {
        ...
        $query = 'SELECT ASPNUMBER, SUM(DSKCAPTY) AS DSKCAPTY, SUM(DSKSTGAVA) AS DSKSTGAVA, SUM(DSKCAPTY - DSKSTGAVA) AS OCCUPATION FROM GFPSYSGES.SSYS05P0 GROUP BY ASPNUMBER ORDER BY ASPNUMBER';
